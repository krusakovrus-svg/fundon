...
const genericSportEvents: Record<string, SportEventRecord[]> = {
  football: [
    {
      ...
      participants: [
        { id: 'lanus', name: 'Lanus', nameRu: 'Ланус' },
        { id: 'newells-old-boys', name: "Newell's Old Boys", nameRu: 'Ньюэллс Олд Бойз' }
      ]
    },
    {
      ...
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'gimnasia-mendoza', name: 'Gimnasia y Esgrima Mendoza', nameRu: 'Химнасия и Эсгрима Мендоса' },
    ...
    },
    {
      ...
      participants: [
        ...
        { id: 'deportivo-riesta', name: 'Deportivo Riesta', nameRu: 'Депортиво Риестра' }
      ]
    },
    {
      id: 'football-brazil-cup-1',
      sportId: 'football',
      title: 'Football · Brazil. Cup · Brazil',
      titleRu: 'Футбол · Бразилия. Кубок · Бразилия',
      startsAt: '2026-03-18T01:00:00+03:00',
      endsAt: '2026-03-18T03:00:00+03:00',
      displayDateEn: 'Tomorrow at',
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'nova-iguacu', name: 'Nova Iguacu', nameRu: 'Нова Игуасу' },
        { id: 'fortaleza', name: 'Fortaleza', nameRu: 'Форталеза' }
      ]
    },
    {
      ...
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'sao-bernardo', name: 'Sao Bernardo', nameRu: 'Сан Бернарду' },
        { id: 'ceara', name: 'Ceara', nameRu: 'Сеара' }
      ]
    }
  ],
  hockey: [
    {
      ...
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'montreal-canadiens', name: 'Montreal', nameRu: 'Монреаль' },
        { id: 'boston-bruins', name: 'Boston', nameRu: 'Бостон' }
      ]
    },
    {
      id: 'hockey-nhl-2',
      ...
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'toronto-maple-leafs', name: 'Toronto', nameRu: 'Торонто' },
        { id: 'new-york-islanders', name: 'NY Islanders', nameRu: 'НЙ Айлендерс' }
      ]
    },
    {
      id: 'hockey-nhl-3',
      ...
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'columbus-blue-jackets', name: 'Columbus', nameRu: 'Коламбус' },
        { id: 'carolina-hurricanes', name: 'Carolina', nameRu: 'Каролина' }
      ]
    },
    {
      id: 'hockey-nhl-4',
      ...
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'chicago-blackhawks', name: 'Chicago', nameRu: 'Чикаго' },
        { id: 'minnesota-wild', name: 'Minnesota', nameRu: 'Миннесота' }
      ]
    },
    {
      id: 'hockey-nhl-5',
      ...
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'winnipeg-jets', name: 'Winnipeg', nameRu: 'Виннипег' },
        { id: 'nashville-predators', name: 'Nashville', nameRu: 'Нэшвилл' }
      ]
    },
    {
      id: 'hockey-nhl-6',
      ...
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'edmonton-oilers', name: 'Edmonton', nameRu: 'Эдмонтон' },
        { id: 'san-jose-sharks', name: 'San Jose', nameRu: 'Сан Хосе' }
      ]
    }
  ],
  tennis: [
    ...
    },
    {
      ...
      participants: [
        ...
        { id: 'osorio-k', name: 'Osorio K.', nameRu: 'Осорио К.' }
      ]
    },
    {
  ...
  basketball: [
    ...
    },
    {
      ...
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'charlotte-hornets', name: 'Charlotte Hornets', nameRu: 'Шарлотт Хорнетс' },
    ...
    },
    {
      ...
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'washington-wizards', name: 'Washington Wizards', nameRu: 'Вашингтон Уизардс' },
    ...
    },
    {
      ...
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'new-york-knicks', name: 'New York Knicks', nameRu: 'Нью-Йорк Никс' },
    ...
    },
    {
      ...
      participants: [
        ...
        { id: 'cleveland-cavaliers', name: 'Cleveland Cavaliers', nameRu: 'Кливленд Кавальерс' }
      ]
    },
    {
      id: 'basketball-nba-6',
      ...
      displayDateRu: 'Завтра в',
      participants: [
        { id: 'minnesota-timberwolves', name: 'Minnesota Timberwolves', nameRu: 'Миннесота Тимбервулвз' },
        { id: 'phoenix-suns', name: 'Phoenix Suns', nameRu: 'Финикс Санз' }
      ]
    }
  ],
  cybersport: [
  ...
  esport: [
    {
      ...
      displayTimeRu: "2-й п., 36'",
      participants: [
        { id: 'minnakhmetov-yel', name: 'Minnakhmetov (YEL)', nameRu: 'Миннахметов (YEL)' },
        { id: 'idrisov-gre', name: 'Idrisov (GRE)', nameRu: 'Идрисов (GRE)' }
      ]
    },
    {
  ...
  boxing: [
    {
      ...
      endsAt: '2026-03-21T03:30:00+03:00',
      participants: [
        { id: 'conlan-m', name: 'Conlan M.', nameRu: 'Конлан М.', country: 'Ireland' },
        { id: 'walsh-k', name: 'Walsh K.', nameRu: 'Уолш К.' }
      ]
    },
    {
      ...
      title: 'Boxing · International · Fights',
      titleRu: 'Бокс · Международные · Бои',
      startsAt: '2026-03-21T22:30:00+03:00',
      endsAt: '2026-03-22T01:30:00+03:00',
      participants: [
        { id: 'sains-j', name: 'Sains J.', nameRu: 'Сэйнс Дж.', country: 'United Kingdom' },
        { id: 'osaze-d', name: 'Osaze D.', nameRu: 'Осазе Д.', country: 'United Kingdom' }
      ]
    },
    {
      ...
      participants: [
        { id: 'vizioli-j', name: 'Vizioli J.', nameRu: 'Визиоли Дж.', country: 'United Kingdom' },
        { id: 'giles-l', name: 'Giles L.', nameRu: 'Джайлз Л.', country: 'United Kingdom' }
      ]
    },
    {
      ...
      endsAt: '2026-03-22T03:30:00+03:00',
      participants: [
        { id: 'liddard-d', name: 'Liddard D.', nameRu: 'Лиддард Д.', country: 'England' },
        { id: 'denny-t', name: 'Denny T.', nameRu: 'Денни Т.' }
      ]
    },
    {
      ...
      title: 'Boxing · International · Fights',
      titleRu: 'Бокс · Международные · Бои',
      startsAt: '2026-03-22T05:30:00+03:00',
      endsAt: '2026-03-22T08:30:00+03:00',
      participants: [
        { id: 'martinez-l', name: 'Martinez L.', nameRu: 'Мартинес Л.' },
        { id: 'alim-i', name: 'Alim I.', nameRu: 'Алим И.' }
      ]
    },
    {
      ...
      title: 'Boxing · International · Fights',
      titleRu: 'Бокс · Международные · Бои',
      startsAt: '2026-03-22T06:30:00+03:00',
      endsAt: '2026-03-22T09:30:00+03:00',
      participants: [
        { id: 'adames-c', name: 'Adames C.', nameRu: 'Адамес К.' },
        { id: 'williams-o', name: 'Williams O.', nameRu: 'Уильямс О.' }
      ]
    },
    {
    ...
    },
    {
      ...
      participants: [
        { id: 'riley-b', name: 'Riley B.', nameRu: 'Райли В.', country: 'United Kingdom' },
    ...
    },
    {
      ...
      title: 'Boxing · International · Fights',
      titleRu: 'Бокс · Международные · Бои',
      startsAt: '2026-04-04T23:30:00+03:00',
      endsAt: '2026-04-05T02:30:00+03:00',
      participants: [
      ...
      participants: [
        {
          ...
          nameRu: 'Гран-при Японии 2026. Гонка. Итоги'
        }
      ]
    },
    {
