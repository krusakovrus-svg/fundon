...
export function LiveDonationDock({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-[5.35rem] z-30 flex justify-center px-4">
      <div
        className="pointer-events-auto w-full rounded-[1.7rem] border border-white/60 bg-[rgba(255,255,255,0.84)] p-3.5 shadow-[0_22px_48px_rgba(15,23,42,0.16)] backdrop-blur-2xl dark:border-white/[0.1] dark:bg-[rgba(var(--surface),0.88)] dark:shadow-[0_28px_56px_rgba(2,6,23,0.42)]"
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  active
                    ? 'border-accent-orange/26 bg-accent-orange/10 text-text-primary shadow-[0_10px_20px_rgba(255,124,65,0.14)]'
