...
export const adminUsersKpis: AdminUsersKpi[] = [
  { id: 'total', label: 'Всего пользователей', value: '5,120', delta: '+2.4%', tone: 'blue' },
  { id: 'active', label: 'Активные сегодня', value: '342', delta: '+18 за час', tone: 'green' },
  { id: 'new', label: 'Новые за 7 дней', value: '118', delta: '+9%', tone: 'blue' },
...
export const adminManagedUsers: AdminManagedUser[] = [
  {
    ...
    donationHistory: [
      ...
      { id: 'alex-2', event: 'Lokomotiv vs Spartak', side: 'Spartak', amount: '₽500', at: 'вчера' },
  ...
  },
  {
    ...
    donationHistory: [
      { id: 'max-1', event: 'UFC Fight Night 271', side: 'Pfeifer', amount: '₽2,000', at: 'сегодня' },
      { id: 'max-2', event: 'Alvarez vs Jones', side: 'Jones', amount: '₽1,500', at: 'вчера' },
      { id: 'max-3', event: 'Spartak vs Zenit', side: 'Зенит', amount: '₽900', at: '3 дня назад' }
    ]
  },
  {
    id: 'user-olga',
    ...
    donationHistory: [
      { id: 'olga-1', event: 'Arsenal London (ж) vs Chelsea (ж)', side: 'Arsenal London (ж)', amount: '₽1,200', at: 'сегодня' },
  ...
  },
  {
    ...
    donationHistory: [
      { id: 'irina-1', event: 'Detroit Pistons vs Los Angeles Lakers', side: 'Los Angeles Lakers', amount: '₽1,800', at: '8 мин назад' },
      { id: 'irina-2', event: 'Miami Open', side: 'Haddad Maia', amount: '₽1,250', at: 'вчера' },
      { id: 'irina-3', event: 'Spartak vs Zenit', side: 'Спартак', amount: '₽1,000', at: '4 дня назад' }
    ]
  }
];
